# Generated by Django 3.2.16 on 2023-05-03 10:54
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('criptionDEAD', models.TextField(blank=True, default='', null=True)),
                ('description', models.TextField(blank=True, default='', null=True)),
                ('damage_type', models.CharField(blank=True, choices=[('scratched', 'Scratched'), ('damaged', 'Damaged'), ('accident', 'Accident'), ('broken', 'Broken')], max_length=20, null=True)),
                ('customer_initial', models.CharField(blank=True, default='', max_length=2, null=True)),
                ...
                ('mileage_start', models.IntegerField(blank=True, default=0, null=True)),
